...
final class RateLimitTests: XCTestCase {
    ...
    func testChallengeDetectionIncludesForbiddenResponses() {
        XCTAssertTrue(NitterClient.isChallenge(statusCode: 403, html: ""))
        XCTAssertTrue(NitterClient.isChallenge(statusCode: 503, html: ""))
        XCTAssertTrue(NitterClient.isChallenge(statusCode: 200, html: "Verifying your browser"))
        XCTAssertFalse(NitterClient.isChallenge(statusCode: 200, html: "Timeline"))
    }
    ...
    private func fakeResponse(headers: [String: String]) -> HTTPURLResponse {
        HTTPURLResponse(
            url: URL(string: "https://nitter.click/test")!,
            statusCode: 429,
