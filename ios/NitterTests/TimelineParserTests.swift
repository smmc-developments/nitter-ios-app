...
final class TimelineParserTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        timeline = try TimelineParser.parse(
            html: html,
            baseURL: try XCTUnwrap(URL(string: "https://nitter.click"))
        )
    }
    ...
    func testProfileCardPreferredOverFirstTweetAuthor() throws {
        ...
        """
        let parsed = try TimelineParser.parse(html: html, baseURL: URL(string: "https://nitter.click")!)
    ...
    func testExpandsTruncatedLinkText() throws {
        ...
        let parsed = try TimelineParser.parse(
            html: html,
            baseURL: XCTUnwrap(URL(string: "https://nitter.click"))
        )
    ...
    func testPinnedTweetFields() {
        ...
        XCTAssertEqual(pinned.statusURL?.absoluteString,
                       "https://nitter.click/NASA/status/1948123456789012345")
    ...
    func testRetweetHeaderAndPhotos() {
        ...
        XCTAssertEqual(
            ...
            "https://nitter.click/pic/pbs.twimg.com%2Fmedia%2Faaa.jpg?name=small&format=webp"
        )
    ...
    func testVideoAndQuote() {
        ...
        XCTAssertEqual(tweet.videoPosterURL?.absoluteString,
                       "https://nitter.click/pic/pbs.twimg.com%2Fext_tw_video_thumb%2Fxyz.jpg?name=small")
        XCTAssertEqual(tweet.videoURL?.absoluteString,
                       "https://nitter.click/video/vid.twimg.com%2Fext_tw_video%2Fxyz%2Fpu%2Fvid%2Favc1%2F640x360%2Fabc.mp4")
    ...
    func testCurrentVideoDownloadMarkup() throws {
        let html = """
        ...
        """
        let tweet = try XCTUnwrap(TimelineParser.parse(
            html: html,
            baseURL: XCTUnwrap(URL(string: "https://nitter.click"))
        ).tweets.first)
        XCTAssertEqual(tweet.videoPosterURL?.absoluteString,
                       "https://nitter.click/pic/amplify_video_thumb%2Fposter.jpg%3Fname%3Dsmall")
        XCTAssertEqual(tweet.videoURL?.absoluteString,
    ...
    func testGarbageHTMLReturnsEmptyTimeline() throws {
        let empty = try TimelineParser.parse(
            ...
            baseURL: URL(string: "https://nitter.click")!
        )
